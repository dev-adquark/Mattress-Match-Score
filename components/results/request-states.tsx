...
export function LoadingState({ label = "Scoring mattresses against your profile…" }: { label?: string }) {
  return (
    <div className="flex animate-fadeIn flex-col items-center gap-3 rounded-xl border border-slate-200 bg-white py-16 text-center">
...
export function ErrorState({ message, onRetry }: { message: string; onRetry: () => void }) {
  return (
    <div className="flex animate-fadeIn flex-col items-center gap-3 rounded-xl border border-red-200 bg-red-50 py-16 text-center">
...
export function NoProfileEmptyState() {
  return (
    <div className="flex animate-fadeIn flex-col items-center gap-3 rounded-xl border border-dashed border-slate-300 bg-white py-16 text-center">
